...
import {
    createNovelTagHandler,
    searchNovelTagHandler,
    getNovelTagByIdHandler,
} from '../controller/noveltag.js'
import {
    createNovelGenreHandler,
    searchNovelGenreHandler,
    getNovelGenreByIdHandler,
} from '../controller/novelgenre.js'
...
import {
    uploadNovelHandler,
    getNovelByIdHandler,
    searchNovelByKeywordHandler,
    deleteNovelHandler,
} from '../controller/novel.js'
...
export default async function registerRoutes(fastify: FastifyInstance) {
    ...
    // Novel Tag (native Fastify handlers)
    ...
    // Novel Genre (native Fastify handlers)
